    ...
    <div class="panel-group" id="subaccordion">
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <a data-toggle="collapse" data-parent="#subaccordion" href="#subcollapseOne">Sub Event Details</a>
            ...
            <div id="subcollapseOne" class="panel-collapse collapse in">
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">Sub Event Owner<span style="color: red">*</span></label>
                                <input class="form-control" type="text" />
                            </div>
                        </div>
                        <div class="col-sm-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">Sub Event Start Date<span style="color: red">*</span></label>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">Sub Event End Date<span style="color: red">*</span></label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">Sub Event Start Time<span style="color: red">*</span></label>
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <label class="control-label">Sub Event End Time<span style="color: red">*</span></label>
                    ...
                    <div>
                        ...
                        <div class="container">
                            <div class=" row">
                                <%--Event Overview--%>
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion2">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#subaccordion2" href="#subcollapsetwo">Sub Event Overview</a>

                                            </div>
                                            <div id="subcollapsetwo" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Goal</label>
                                ...
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion3">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#accordion3" href="#subcollapseThree">Sub Event Budget</a>

                                            </div>
                                            <div id="subcollapseThree" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Anticipated</label>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion4">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#subaccordion4" href="#subcollapseFour">Sub Event Participants / Banner ID #</a>

                                            </div>
                                            <div id="subcollapseFour" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Sponsors</label>
                                ...
                                <%--Marketing panel--%>
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion5">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#subaccordion5" href="#subcollapseFive">Sub Marketing & Communication</a>

                                            </div>
                                            <div id="subcollapseFive" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Pre-Event correspondence</label>
                            ...
                            <div class="row">
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion6">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#subaccordion6" href="#subcollapseSix">Sub PreEvent Logistics</a>

                                            </div>
                                            <div id="subcollapseSix" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Catering</label>
                                ...
                                <%--post event panel--%>
                                <div class="col-lg-5">
                                    <div class="pannel-group" id="subaccordion7">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">

                                                <a data-toggle="collapse" data-parent="#subaccordion7" href="#subcollapseSeven">Sub Post Event Activities</a>

                                            </div>
                                            <div id="subcollapseSeven" class="panel-collapse collapse out">
                                                <div class="panel-body">
                                                    <div class="checkbox">
                                                        <label>
                                                            <input type="checkbox" value="">Debrief meeting</label>
